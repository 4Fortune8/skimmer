...
YoutubeProfiles = pd.read_csv('data\profiles\profiles{now.year}-{now.month}.csv', index_col=0)
...
STinyChannels.to_csv('data/{now.year}-{now.month}newviewsSTinyexport.csv')
TinyChannels.to_csv('data/{now.year}-{now.month}newviewstinyexport.csv')
SuperSmallChannels.to_csv('data/{now.year}-{now.month}newviewsupersmallexport.csv')
SmallChannels.to_csv('data/{now.year}-{now.month}newviewssmallexport.csv')
MediumChannels.to_csv('data/{now.year}-{now.month}newviewssmediumexport.csv')
LargeChannels.to_csv('data/{now.year}-{now.month}newviewslargeexport.csv')
MassiveChannels.to_csv('data/{now.year}-{now.month}newviewsmassiveexport.csv')
...
STinyChannels.to_csv('data/{now.year}-{now.month}suscribersChangesSTinyexport.csv')
TinyChannels.to_csv('data/{now.year}-{now.month}suscribersChangestinyexport.csv')
SuperSmallChannels.to_csv('data/{now.year}-{now.month}suscribersChangesupersmallexport.csv')
SmallChannels.to_csv('data/{now.year}-{now.month}suscribersChangesmallexport.csv')
MediumChannels.to_csv('data/{now.year}-{now.month}suscribersChangemediumexport.csv')
LargeChannels.to_csv('data/{now.year}-{now.month}suscribersChangelargeexport.csv')
MassiveChannels.to_csv('data/{now.year}-{now.month}suscribersChangemassiveexport.csv')


STinyChannels = STinyChannels.sort_values('earninghigh', ascending=False)
STinyChannels.to_csv('data/{now.year}-{now.month}earninghighSTinyexport.csv')
